...
import argparse
import json
from data_agent_doctor.models import SEVERITY_RANK
from data_agent_doctor.reporters.console import print_console_report
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="data-agent-doctor",
        description="Scan AI/data-agent projects for production-readiness risks.",
    )
